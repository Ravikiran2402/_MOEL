...
def evaluate(model, data,  ty='valid', max_dec_step=30):
    ...
    for j, batch in pbar:
        #print(type(batch))
        loss1,loss2,loss, ppl, bce_prog, acc_prog = model.train_one_batch(batch, 0, train=False)
    ...
    return loss1,loss2,loss, math.exp(min(100,loss)), bce, acc, bleu_score_g, bleu_score_b
